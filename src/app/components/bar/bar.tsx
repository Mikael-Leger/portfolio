    ...
    return (
        <div className="window-bar" style={{ "backgroundColor": preferences.color?.backgroundShadedColor }}>
            <div className="window-bar-actions">
                ...
                <img className="logo-icon-actions-forward logo-icon" src="/forward.png" style={{ filter: (preferences.color?.textColor == 'white' ? 'invert(100%)' : '') + ' brightness(50%)' }} />
                <img className="logo-icon-actions-refresh logo-icon" src="/refresh.png" style={{ filter: preferences.color?.textColor == 'white' ? 'invert(100%)' : '' }} />
            </div>
