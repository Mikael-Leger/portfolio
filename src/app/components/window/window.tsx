...
export default function Window({ type, tabs, lines, onFinish, hide = false }: WindowProps) {
	...
	const commandLogic = isCommand ? useCommand(lines, onFinish, preferences, ip) : null;
	...
	return (
		<WindowDiv
			className={`window window-${type}-${id}`}
			$preferences={preferences}
